-----------------------------------------------------------
-- nvim-web-devicons configuration file
-----------------------------------------------------------
...
devicons.setup({
	...
	-- (default to nil)
	variant = nil, -- "light" or "dark" or nil for auto
	...
	override_by_filename = {
		-- Add filename-specific overrides here
		-- Example:
		-- [".gitignore"] = {
		-- 	icon = "",
		-- 	color = "#f1502f",
	...
	override_by_extension = {
		-- Add extension-specific overrides here
		-- Example:
		-- ["log"] = {
		-- 	icon = "",
		-- 	color = "#81e043",
	...
	override_by_operating_system = {
		-- Add OS-specific overrides here
		-- Example:
		-- ["apple"] = {
		-- 	icon = "",
		-- 	color = "#A2AAAD",
